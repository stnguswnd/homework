  ...
  return (
    <div className="min-h-screen bg-paper">
      <div className="mx-auto flex max-w-7xl flex-col md:flex-row">
        <aside className="border-b border-line bg-white p-4 md:sticky md:top-0 md:h-screen md:w-64 md:border-b-0 md:border-r">
          <Link href="/teacher/dashboard" className="block text-lg font-bold">Homework Studio</Link>
        ...
        <main className="flex-1 p-4 md:p-8">
          <header className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm font-semibold text-action">강사용 목업</p>
